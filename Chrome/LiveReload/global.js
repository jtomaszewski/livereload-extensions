...
TabState = (function() {
  ...
  TabState.prototype.enable = function(host) {
    this.host = this.host || LiveReloadGlobal.host;
...
LiveReloadGlobal = {
  ...
  beforeEnablingFirst: function(callback, host) {
    ...
    console.log("Connecting to ws://" + host + ":" + this.port + "/livereload...");
    ws = new TheWebSocket("ws://" + host + ":" + this.port + "/livereload");
    ws.onerror = function() {
    ...
    return ws.onmessage = function(event) {
      ...
      if (event.data.match(/^!!/)) {
        ...
        xhr.open("GET", "http://" + host + ":" + _this.port + "/livereload.js", true);
